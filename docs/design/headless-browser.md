...
| 3 | Frame documents, realm-owned globals and classic script execution ([#3771](https://github.com/sebastienros/jint/issues/3771)) | [#3667](https://github.com/sebastienros/jint/pull/3667), realm brands [#4068](https://github.com/sebastienros/jint/pull/4068), child scripts [#4069](https://github.com/sebastienros/jint/pull/4069) | Same-origin, unsandboxed sourced frames run classic scripts and markup handlers on the page loop in their own document realms, with distinct globals, intrinsics, DOM/UI constructors and window listeners. Empty iframes, child modules, WindowProxy navigation, cross-origin/sandbox execution and child-specific browser services remain separate work. Native creation followed by native adoption before any binding observation remains the integration gap in [#3971](https://github.com/sebastienros/jint/issues/3971) |
...
| 6 | A navigation is a fetch and a new engine; forms, history, cookies, storage and workers | [#3667](https://github.com/sebastienros/jint/pull/3667), child scripts [#4069](https://github.com/sebastienros/jint/pull/4069) | Images fetch under `MaxImageRequests` and report availability, header dimensions and load/error events without pixel decoding ([#4011](https://github.com/sebastienros/jint/pull/4011)); zero disables image requests. Supported child frames run classic scripts under the page budgets; their Web APIs use the page network configuration, child-specific browser services remain incomplete, and location writes throw ([#3771](https://github.com/sebastienros/jint/issues/3771)) |
