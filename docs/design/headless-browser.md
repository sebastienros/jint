...
| 6 | A navigation is a fetch and a new engine; forms, history, cookies, storage and workers | [#3667](https://github.com/sebastienros/jint/pull/3667), child scripts [#4069](https://github.com/sebastienros/jint/pull/4069) | Images are recorded in `Page.Requests` as *not* fetched, there being nothing to render them with. Supported child frames run classic scripts under the page budgets; their Web APIs use the page network configuration, child-specific browser services remain incomplete, and location writes throw ([#3771](https://github.com/sebastienros/jint/issues/3771)) |
