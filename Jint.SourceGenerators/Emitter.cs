...
internal static class Emitter
{
    public static string Emit(ObjectDefinition obj)
    {
        ...
        // MA0195: static field 'X' may not be initialized yet — forward refs to user-defined static
        // [JsProperty] fields in the partial class are intentional. The C# compiler orders partial
        // files lexically (user .cs before generator .g.cs) so the user fields are always
        // initialized before the descriptor fields below; the warning is structurally noise here.
        sb.AppendLine("#pragma warning disable MA0195");
        sb.AppendLine();
