...
namespace Jint.Native.Object
{
...
#endif
    {
        ...
        private IEnumerable<KeyValuePair<string, IPropertyDescriptor>> EnumerableValues =>
            Instance.GetOwnProperties().Where(x => x.Value.Enumerable.HasValue && x.Value.Enumerable.Value == true);
