...
internal sealed class PlainDateConstructor : Constructor
{
    ...
    {
        Throw.TypeError(_realm, "Temporal.PlainDate.from is not yet implemented");
        return Undefined;
    }

    private JsValue Compare(JsValue thisObject, JsCallArguments arguments)
    {
        Throw.TypeError(_realm, "Temporal.PlainDate.compare is not yet implemented");
        return Undefined;
    }
    ...
    {
        Throw.TypeError(_realm, "Temporal.PlainDate constructor is not yet implemented");
        return null!;
    }
}
