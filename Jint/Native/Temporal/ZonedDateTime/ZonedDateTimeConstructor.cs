...
internal sealed class ZonedDateTimeConstructor : Constructor
{
    ...
    {
        Throw.TypeError(_realm, "Temporal.ZonedDateTime.from is not yet implemented");
        return Undefined;
    }

    private JsValue Compare(JsValue thisObject, JsCallArguments arguments)
    {
        Throw.TypeError(_realm, "Temporal.ZonedDateTime.compare is not yet implemented");
        return Undefined;
    }
    ...
    {
        Throw.TypeError(_realm, "Temporal.ZonedDateTime constructor is not yet implemented");
        return null!;
    }
}
