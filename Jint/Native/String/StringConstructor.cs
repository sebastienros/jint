...
namespace Jint.Native.String
{
    ...
    public sealed class StringConstructor : FunctionInstance, IConstructor
    {
        ...
        /// </summary>
        private static JsValue FromCharCode(JsValue thisObj, in Arguments arguments)
        {
            ...
            var elements = (length < 512 ? stackalloc char[512] : new char[length]).Slice(0, length);
#else
        ...
        private JsValue FromCodePoint(JsValue thisObj, in Arguments arguments)
        {
            ...
            for (int i = 0; i < arguments.Length; ++i)
            {
                ...
                {
                    result += FromCharCode(null, new Arguments(codeUnits.ToArray(), codeUnits.Count));
                    codeUnits.Clear();
                }
            }

            return result + FromCharCode(null, new Arguments(codeUnits.ToArray(), codeUnits.Count));
        }

        /// <summary>
        /// https://www.ecma-international.org/ecma-262/6.0/#sec-string.raw
        /// </summary>
        private JsValue Raw(JsValue thisObj, in Arguments arguments)
        {
