...
internal static class TimeZoneData
{
    ...
    /// <summary>
    /// All canonical IANA timezone identifiers (Zone names and Link names).
    /// This list is based on IANA TZDB and ECMA-402 requirements.
    /// </summary>
    ...
    /// <summary>
    /// Gets all supported IANA timezone identifiers in canonical form.
    /// </summary>
