...
public sealed class RelativeTimePatterns
{
    ...
    /// </summary>
    public required string Future { get; init; }
    ...
    /// </summary>
    public required string FuturePlural { get; init; }

    /// <summary>
    /// Pattern for past plural. E.g., "{0} days ago".
    /// </summary>
    public required string PastPlural { get; init; }
}
...
public sealed class UnitPatterns
{
    ...
    /// <summary>
    /// Pattern for plural. E.g., "{0} meters".
    /// </summary>
