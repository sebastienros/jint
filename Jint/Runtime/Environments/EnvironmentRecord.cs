...
namespace Jint.Runtime.Environments
{
    ...
    public abstract class EnvironmentRecord : JsValue
    {
        ...
        internal abstract bool TryGetBinding(string name,
            bool strict,
            out Binding binding,
            out JsValue value);
        ...
        public abstract void CreateMutableBinding(JsValue name, JsValue value, bool canBeDeleted = false);
        ...
        public abstract void SetMutableBinding(JsValue name, JsValue value, bool strict);
        ...
        public abstract JsValue GetBindingValue(JsValue name, bool strict);
        ...
        public abstract bool DeleteBinding(JsValue name);
    ...
    internal readonly struct KeyValue
    {
        ...
        public KeyValue(Key key, JsValue value)
        {
            Key = key;
            Value = value;
        }
