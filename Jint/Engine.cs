...
public sealed partial class Engine : IDisposable
{
    ...
    /// engine whose <see cref="ClrTypeConverter"/> is not the stock one.
    /// </summary>
    /// <remarks>
    ...
    /// the process. <see cref="InstallTypeConverter"/> drops these when the converter changes.
    /// </remarks>
    ...
    internal void InstallTypeConverter(ClrTypeConverter converter, Type[]? declaredTargetTypes)
    {
        ...
        // Every operator-overload resolution this engine remembered was scored against the converter being
        // replaced, and the stock table it may now be entitled to was not. Nothing is resolved before the
        // first install, so this is a no-op during construction.
