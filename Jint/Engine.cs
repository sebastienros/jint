...
public sealed partial class Engine : IDisposable
{
    ...
    /// with <see cref="InvalidOperationException"/>, which contradicts what docs/packages/jint/thread-safety.md
    ...
    /// not a claiming scope either. That drain is one of the windows docs/packages/jint/thread-safety.md
