    ...
    public class JavascriptParser
    {
        ...
        private static bool IsIdentifierStart(char ch)
        {
            return (ch == '$') || (ch == '_') || 
                   ...
                   (ch >= 'a' && ch <= 'z') ||
                   (ch == '\\') || 
                   ((ch >= 0x80) && Regexes.NonAsciiIdentifierStart.IsMatch(ch.ToString(CultureInfo.InvariantCulture)));
        }
        ...
        private static bool IsIdentifierPart(char ch)
        {
            return (ch == '$') || (ch == '_') ||
                   ...
                   (ch >= '0' && ch <= '9') ||
                   (ch == '\\') || 
                   ((ch >= 0x80) && Regexes.NonAsciiIdentifierPart.IsMatch(ch.ToString(CultureInfo.InvariantCulture)));
        }
        ...
        {
            // todo: use char.ConvertFromUtf32
            ...
            for (int i = 0; i < len; ++i)
            {
                if (_index < _length && IsHexDigit(_source.CharCodeAt(_index)))
                {
                    char ch = _source.CharCodeAt(_index++);
                    code = code*16 +
                           "0123456789abcdef".IndexOf(ch.ToString(CultureInfo.InvariantCulture),
        ...
        {
            char ch = _source.CharCodeAt(_index++);
            string id = ch.ToString(CultureInfo.InvariantCulture);
            ...
            if (ch == 92)
            {
                ...
                id = ch.ToString(CultureInfo.InvariantCulture);
            }
        ...
        private Token ScanPunctuator()
        {
                                ...
                                return new Token
                                    {
                                        ...
                                        Value =
                                            ...
                                            code2.ToString(CultureInfo.InvariantCulture),
                                        LineNumber = _lineNumber,
                                        LineStart = _lineStart,
                                        Range = new[] {start, _index}
                                    };
            ...
            if (ch1 == ch2 && ("+-<>&|".IndexOf(ch1) >= 0))
            {
                ...
                return new Token
                    {
                        Type = Tokens.Punctuator,
                        Value = ch1.ToString(CultureInfo.InvariantCulture) + ch2.ToString(CultureInfo.InvariantCulture),
                        LineNumber = _lineNumber,
                        LineStart = _lineStart,
                        Range = new[] {start, _index}
                    };
            ...
            if ("<>=!+-*%&|^/".IndexOf(ch1) >= 0)
            {
                ...
                return new Token
                    {
                        Type = Tokens.Punctuator,
                        Value = ch1.ToString(CultureInfo.InvariantCulture),
                        LineNumber = _lineNumber,
                        LineStart = _lineStart,
                        Range = new[] {start, _index}
                    };
        ...
        private Token ScanNumericLiteral()
        {
            ...
            if (ch != '.')
            {
                number = _source.CharCodeAt(_index++).ToString(CultureInfo.InvariantCulture);
                ch = _source.CharCodeAt(_index);
        ...
        private Token ScanRegExp()
        {
            ...
            string str = _source.CharCodeAt(_index++).ToString(CultureInfo.InvariantCulture);
