...
internal sealed partial class Foo
{
    ...
    private void CreateProperties_Generated()
    {
        ...
        properties["tag"] = new global::Jint.Runtime.Descriptors.Specialized.LazyPropertyDescriptor<Foo>(this, static host => new __FooFunction(host, __FooFunction.Slot.Tag), global::Jint.Runtime.Descriptors.PropertyFlag.NonEnumerable);
