...
internal sealed partial class Foo
{
    ...
    private void CreateProperties_Generated()
    {
        ...
        properties.AddDangerous(__Key_tag, new global::Jint.Runtime.Descriptors.Specialized.LazyPropertyDescriptor<Foo>(this, static host => new __FooFunction(host, __FooFunction.Slot.Tag), global::Jint.Runtime.Descriptors.PropertyFlag.NonEnumerable));
    ...
    private sealed class __FooFunction : global::Jint.Native.Function.Function
    {
        ...
        private static global::Jint.Native.JsString GetName(Slot slot)
        {
            switch (slot)
            {
                case Slot.Tag: return global::Jint.Native.JsString.CachedCreate("tag");
