...
internal sealed partial class Foo
{
    ...
    private void CreateProperties_Generated()
    {
        ...
        properties["bar"] = new global::Jint.Runtime.Descriptors.Specialized.LazyPropertyDescriptor<Foo>(this, static host => new __FooFunction(host, __FooFunction.Slot.Bar), global::Jint.Runtime.Descriptors.PropertyFlag.NonEnumerable);
