...
internal sealed partial class Foo
{
    ...
    private void CreateProperties_Generated()
    {
        ...
        properties.AddDangerous(__Key_trunc, new global::Jint.Runtime.Descriptors.Specialized.LazyPropertyDescriptor<Foo>(this, static host => new __FooFunction(host), global::Jint.Runtime.Descriptors.PropertyFlag.NonEnumerable));
    ...
    private sealed class __FooFunction : global::Jint.Native.Function.Function
    {
        ...
        internal __FooFunction(Foo host)
            : base(host.Engine, host._realm, global::Jint.Native.JsString.CachedCreate("trunc"))
        {
            _host = host;
        ...
        {
            return Foo.Trunc(thisObject, global::Jint.Runtime.TypeConverter.ToNumber(global::Jint.Runtime.Arguments.At(arguments, 0)));
        }
        ...
        {
            return Foo.Trunc(thisObject, global::Jint.Runtime.TypeConverter.ToNumber(arg0));
        }
    }
}
