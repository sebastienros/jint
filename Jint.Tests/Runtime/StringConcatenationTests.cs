...
public class StringConcatenationTests
{
    ...
    /// </summary>
    [Theory]
    [InlineData("y + '-' + m", "2007-11")]
    [InlineData("'[' + y + ']' + m", "[2007]11")]
    [InlineData("y + '-' + m + '-' + d", "2007-11-29")]
    [InlineData("y + '-' + m + '-' + d + ' ' + y + ':' + m + ':' + d", "2007-11-29 2007:11:29")]
    [InlineData("'' + y + m + d", "20071129")]
    [InlineData("'' + y + m + d + '.'", "20071129.")]
    [InlineData("y + '-' + m + '-' + d + '!'", "2007-11-29!")]
    ...
    {
        if (!GCPolyfills.TryGetAllocatedBytesForCurrentThread(out _))
        {
    ...
    [InlineData("s = s + chunk + chunk + chunk + chunk")]
    [InlineData("s = chunk + chunk + chunk + chunk + s")]
