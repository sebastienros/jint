...
public class UrlTests
{
    ...
    [TestCase("url.fileURLToPath('file:///hello world', { windows: false })", "/hello world")]
    [TestCase("url.fileURLToPath('file:///%E4%BD%A0%E5%A5%BD.txt', { windows: false })", "/\u4f60\u597d.txt")]
    [TestCase("url.fileURLToPath('file:///foo/bar', { windows: false })", "/foo/bar")]
    [TestCase("url.fileURLToPath('file:///', { windows: false })", "/")]
    [TestCase("url.fileURLToPath('file://localhost/foo', { windows: false })", "/foo")]
    [TestCase("url.fileURLToPath('file:///a/%2e%2e/b', { windows: false })", "/b")]
    [TestCase("url.fileURLToPath(new URL('file:///foo/bar'), { windows: false })", "/foo/bar")]
    [TestCase("url.fileURLToPath('file:///C:/path/', { windows: false })", "/C:/path/")]
    [TestCase("url.fileURLToPath('file:///C:/path/', { windows: true })", "C:\\path\\")]
    [TestCase("url.fileURLToPath('file:///C:/path/file.txt', { windows: true })", "C:\\path\\file.txt")]
    [TestCase("url.fileURLToPath('file://nas/foo.txt', { windows: true })", "\\\\nas\\foo.txt")]
    [TestCase("url.fileURLToPath('file:///c:/foo%20bar', { windows: true })", "c:\\foo bar")]
    [TestCase("url.fileURLToPath('file:///D:/a/b/c', { windows: true })", "D:\\a\\b\\c")]
    [TestCase("url.pathToFileURL('/foo#1', { windows: false }).href", "file:///foo%231")]
    [TestCase("url.pathToFileURL('/some/path%.c', { windows: false }).href", "file:///some/path%25.c")]
    [TestCase("url.pathToFileURL('/foo/bar', { windows: false }).href", "file:///foo/bar")]
    [TestCase("url.pathToFileURL('/foo/bar/', { windows: false }).href", "file:///foo/bar/")]
    [TestCase("url.pathToFileURL('/hello world', { windows: false }).href", "file:///hello%20world")]
    [TestCase("url.pathToFileURL('/a?b', { windows: false }).href", "file:///a%3Fb")]
    [TestCase("url.pathToFileURL('/\\u4e2d\\u6587.txt', { windows: false }).href", "file:///%E4%B8%AD%E6%96%87.txt")]
    [TestCase("url.pathToFileURL('/a/../b', { windows: false }).href", "file:///b")]
    [TestCase("url.pathToFileURL('C:\\\\path\\\\', { windows: true }).href", "file:///C:/path/")]
    [TestCase("url.pathToFileURL('C:\\\\path\\\\file.txt', { windows: true }).href", "file:///C:/path/file.txt")]
    [TestCase("url.pathToFileURL('\\\\\\\\nas\\\\share\\\\file.txt', { windows: true }).href", "file://nas/share/file.txt")]
    [TestCase("url.pathToFileURL('C:\\\\a b\\\\c#d', { windows: true }).href", "file:///C:/a%20b/c%23d")]
    [TestCase("url.fileURLToPath(url.pathToFileURL('/a b/c#d', { windows: false }), { windows: false })", "/a b/c#d")]
    [TestCase("url.fileURLToPath(url.pathToFileURL('C:\\\\a b\\\\c#d', { windows: true }), { windows: true })", "C:\\a b\\c#d")]
    ...
    /// </summary>
    [IgnoreUnless(nameof(FullIdna), "The platform's IDNA implementation is not the URL Standard's")]
    [TestCase("espa\u00f1ol.com", "xn--espaol-zwa.com")]
    [TestCase("\u4e2d\u6587.com", "xn--fiq228c.com")]
    [TestCase("xn--i\u00f1valid.com", "")]
    ...
    /// </summary>
    [IgnoreUnless(nameof(FullIdna), "The platform's IDNA implementation is not the URL Standard's")]
    [TestCase("xn--espaol-zwa.com", "espa\u00f1ol.com")]
    [TestCase("xn--fiq228c.com", "\u4e2d\u6587.com")]
    [TestCase("xn--i\u00f1valid.com", "")]
    ...
    /// </summary>
    [TestCase("url.domainToASCII('example.com')", "example.com")]
    [TestCase("url.domainToASCII('EXAMPLE.com')", "example.com")]
    [TestCase("url.domainToASCII('')", "")]
    [TestCase("url.domainToUnicode('example.com')", "example.com")]
    [TestCase("url.domainToUnicode('')", "")]
    ...
    /// </summary>
    [TestCase("url.fileURLToPath('https://example.com/x')", "scheme file")]
    [TestCase("url.fileURLToPath('file://host/x', { windows: false })", "must be \"localhost\" or empty")]
    [TestCase("url.fileURLToPath('file:///a%2Fb', { windows: false })", "encoded / characters")]
    [TestCase("url.fileURLToPath('file:///a%2fb', { windows: true })", "encoded \\ or / characters")]
    [TestCase("url.fileURLToPath('file:///a%5Cb', { windows: true })", "encoded \\ or / characters")]
    [TestCase("url.fileURLToPath('file:///foo', { windows: true })", "must be absolute")]
    [TestCase("url.fileURLToPath('not a url')", "Invalid URL")]
    [TestCase("url.fileURLToPath(42)", "string or URL")]
    ...
    /// </summary>
    [TestCase(@"url.pathToFileURL('\\\\server', { windows: true })", "missing UNC resource path")]
    [TestCase(@"url.pathToFileURL('\\\\\\share', { windows: true })", "empty UNC servername")]
    ...
    /// </summary>
    [TestCase("win32", "C:\\path\\file.txt")]
    [TestCase("linux", "/C:/path/file.txt")]
