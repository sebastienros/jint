...
{
    [Theory]
    [InlineData("(() => { let sum = 0; for (let i = 0; i < 100000; i++) sum += i % 97; return sum; })()", 4799685)]
    [InlineData("(() => { const o = {n:17}; let sum = 0; for (let i = 0; i < 100000; i++) sum += o.n; return sum; })()", 1700000)]
    [InlineData("(() => { function f(n) { return n % 97; } let sum = 0; for (let i = 0; i < 100000; i++) sum += f(i); return sum; })()", 4799685)]
