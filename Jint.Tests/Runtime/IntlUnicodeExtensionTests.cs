...
public class IntlUnicodeExtensionTests
{
    ...
    /// </summary>
    [Theory]
    [InlineData("en-US-u-ca-buddhist", "en-US-u-ca-buddhist", "buddhist", "latn", "h12")]
    [InlineData("en-US-u-nu-arab", "en-US-u-nu-arab", "gregory", "arab", "h12")]
    [InlineData("en-US-u-ca-buddhist-nu-arab", "en-US-u-ca-buddhist-nu-arab", "buddhist", "arab", "h12")]
    [InlineData("en-US-u-nu-arab-ca-buddhist", "en-US-u-ca-buddhist-nu-arab", "buddhist", "arab", "h12")]
    [InlineData("en-US-u-ca-buddhist-hc-h23", "en-US-u-ca-buddhist-hc-h23", "buddhist", "latn", "h23")]
    [InlineData("en-US-u-hc-h23-ca-buddhist", "en-US-u-ca-buddhist-hc-h23", "buddhist", "latn", "h23")]
    [InlineData("en-US-u-hc-h23-nu-arab-ca-buddhist", "en-US-u-ca-buddhist-hc-h23-nu-arab", "buddhist", "arab", "h23")]
    ...
    /// </summary>
    [Theory]
    [InlineData("en-US-u-ca-buddhist", "en-US", "latn")]
    [InlineData("en-US-u-nu-arab", "en-US-u-nu-arab", "arab")]
    [InlineData("en-US-u-ca-buddhist-nu-arab", "en-US-u-nu-arab", "arab")]
    [InlineData("en-US-u-nu-arab-ca-buddhist", "en-US-u-nu-arab", "arab")]
    [InlineData("en-US-u-hc-h23-nu-arab-ca-buddhist", "en-US-u-nu-arab", "arab")]
    ...
    /// </summary>
    [Theory]
    [InlineData("en-US-u-ca-buddhist-nu-arab", "ca", "buddhist")]
    [InlineData("en-US-u-ca-buddhist-nu-arab", "nu", "arab")]
    [InlineData("en-US-u-nu-arab-ca-buddhist", "ca", "buddhist")]
    [InlineData("en-US-u-ca-islamic-civil-nu-arab", "ca", "islamic-civil")]
    [InlineData("en-US-u-foo-bar-ca-buddhist", "ca", "buddhist")]
    [InlineData("en-US-u-nu-arab-x-ca-gregory", "ca", null)]
    [InlineData("en-US-x-u-ca-gregory", "ca", null)]
    [InlineData("en-US-u-kn-ca-buddhist", "kn", "")]
    [InlineData("en-US-u-kn-ca-buddhist", "ca", "buddhist")]
    [InlineData("en-US-u-CA-BUDDHIST", "ca", "buddhist")]
    [InlineData("en-US", "ca", null)]
    ...
    [Theory]
    [InlineData("en-US-u-ca-buddhist-nu-arab", "en-US")]
    [InlineData("en-US-u-nu-arab-x-private", "en-US-x-private")]
    [InlineData("en-US-t-en-latn-u-nu-arab", "en-US-t-en-latn")]
    ...
    [Theory]
    [InlineData("en-US", "nu", "arab", "en-US-u-nu-arab")]
    [InlineData("en-US-u-ca-buddhist", "nu", "arab", "en-US-u-ca-buddhist-nu-arab")]
    [InlineData("en-US-u-nu-latn-ca-buddhist", "nu", "arab", "en-US-u-ca-buddhist-nu-arab")]
    [InlineData("en-US-u-ca-buddhist-nu-arab", "nu", null, "en-US-u-ca-buddhist")]
    [InlineData("en-US-u-nu-arab", "nu", null, "en-US")]
    [InlineData("en-US-x-private", "nu", "arab", "en-US-u-nu-arab-x-private")]
    [InlineData("en-US-u-nu-arab-x-private", "nu", null, "en-US-x-private")]
    [InlineData("en-US-u-foo-nu-arab", "nu", null, "en-US-u-foo")]
