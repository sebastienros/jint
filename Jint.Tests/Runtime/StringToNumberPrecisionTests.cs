...
public class StringToNumberPrecisionTests
{
    ...
    [Theory]
    [InlineData("1995089590579635589", "1995089590579635700")]
    ...
    /// </summary>
    [Theory]
    [InlineData("parseFloat", NumberShape.WholeNumber)]
    [InlineData("parseFloat", NumberShape.Fraction)]
    [InlineData("parseFloat", NumberShape.Exponent)]
    [InlineData("parseFloat", NumberShape.Subnormal)]
    [InlineData("Number", NumberShape.WholeNumber)]
    [InlineData("Number", NumberShape.Fraction)]
    [InlineData("Number", NumberShape.Exponent)]
    [InlineData("Number", NumberShape.Subnormal)]
    [InlineData("JSON.parse", NumberShape.WholeNumber)]
    [InlineData("JSON.parse", NumberShape.Fraction)]
    [InlineData("JSON.parse", NumberShape.Exponent)]
    [InlineData("JSON.parse", NumberShape.Subnormal)]
