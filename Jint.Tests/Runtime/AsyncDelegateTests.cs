...
namespace Jint.Tests.Runtime
{
    public class AsyncDelegateTests
    {
        ...
        public static async Task<object> ReturnAsync(object input)
        {
        ...
        [Fact]
        public async void DelegateAsArrayIndexIsAwaited()
        {
            var engine = new Engine();

            var testMethods = new TestMethods();
            SetupClrDelegates(engine, testMethods);
            // Delegate calculates an array index
        ...
        [Fact]
        public async void DelegateAsObjectPropertyNameIsAwaited()
        {
            var engine = new Engine();

            var testMethods = new TestMethods();
            SetupClrDelegates(engine, testMethods);
            // Delegate calculates an object property name
