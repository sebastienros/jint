...
public class ParseIntPrecisionTests
{
    ...
    /// <summary>
    /// Every radix <c>parseInt</c> accepts, one theory case each.
    /// </summary>
    public static TheoryData<int> EveryRadix
    {
        get
        {
            var radixes = new TheoryData<int>();
    ...
    /// </summary>
    [Theory]
    [InlineData("678851690709701306", "678851690709701200")]
    [InlineData("2499781153938996520", "2499781153938996700")]
    [InlineData("1302819948463508623", "1302819948463508700")]
    ...
    /// </summary>
    [Theory]
    [MemberData(nameof(EveryRadix))]
    public void AMidpointBetweenTwoDoublesRoundsToEven(int radix)
    {
        var engine = new Engine();
    ...
    [Theory]
    [MemberData(nameof(EveryRadix))]
    public void EveryRadixSaturatesAtItsOwnOverflowBoundary(int radix)
    {
        var engine = new Engine();
        var random = new Random(20260901 + radix);
    ...
    [InlineData("12.9", 12)]
    [InlineData("1e3", 1)]
    [InlineData("00000000000000000000000000000000000000009", 9)]
    [InlineData("99999999999999999999999x", 1e23)]
    ...
    [InlineData("z", 36, 35)]
    [InlineData("Z", 36, 35)]
    [InlineData("zz", 35, double.NaN)]
    [InlineData("8", 8, double.NaN)]
    [InlineData("777", 8, 511)]
    [InlineData("11", 1, double.NaN)]
    [InlineData("11", 37, double.NaN)]
    [InlineData("0x10", 16, 16)]
    [InlineData("0x10", 8, 0)]
