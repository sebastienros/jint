...
public class NumericLiteralPrecisionTests
{
    ...
    [InlineData("9223372036854776833", "9223372036854778000")]
    [InlineData("14706402211007785958", "14706402211007785000")]
    [InlineData("10157050723211089077", "10157050723211090000")]
    [InlineData("0xAB54A98CEB1F0AD2", "12345678901234567000")]
    [InlineData("0o1255245230635307605322", "12345678901234567000")]
    [InlineData("0b1010101101010100101010011000110011101011000111110000101011010010", "12345678901234567000")]
    [InlineData("12_345_678_901_234_567_890", "12345678901234567000")]
    [InlineData("01255245230635307605322", "12345678901234567000")]
    // Controls: exactly representable, or outside the range the conversion mishandles.
    [InlineData("12345678901234567168", "12345678901234567000")]
    [InlineData("9223372036854775808", "9223372036854776000")]
    [InlineData("18446744073709551615", "18446744073709552000")]
    [InlineData("18446744073709551616", "18446744073709552000")]
    [InlineData("9007199254740993", "9007199254740992")]
    [InlineData("123456789012345678901234567890", "1.2345678901234568e+29")]
    ...
    [Theory]
    [InlineData("0x1F49E9EE4C1BCE961", "36073444770624370000")]
    [InlineData("0x1F49_E9EE_4C1B_CE961", "36073444770624370000")]
    [InlineData("0b1111110101010110111011001100011110100011000000100101101011000110110000", "1.1683224628333037e+21")]
    [InlineData("0o1777777777777777777777777", "9.44473296573929e+21")]
    [InlineData("0xFFFFFFFFFFFFFFFFF", "295147905179352830000")]
    [InlineData("0b1111111111111111111111111111111111111111111111111111111111111111111111", "1.1805916207174113e+21")]
    ...
    [InlineData("0x10000000000000800", "18446744073709552000")]
    [InlineData("0x10000000000001800", "18446744073709560000")]
    [InlineData("0x10000000000000801", "18446744073709556000")]
    [InlineData("0x100000000000007FF", "18446744073709552000")]
    // Controls: exactly representable, so they always scanned correctly.
    [InlineData("0x10000000000000000", "18446744073709552000")]
    [InlineData("0x100000000000000000000000000000000", "3.402823669209385e+38")]
    ...
    [Theory]
    [InlineData("28643790.0509245228", "28643790.05092452")]
    [InlineData("414404623.816719085", "414404623.8167191")]
    [InlineData("123456789.012345678", "123456789.01234567")]
    [InlineData("1.95232124646081910e-200", "1.952321246460819e-200")]
    [InlineData("4.21015488674265630e+200", "4.2101548867426566e+200")]
    [InlineData("5.14083278005553983e-200", "5.1408327800555395e-200")]
    [InlineData("1898787416396742135391", "1.8987874163967423e+21")]
    [InlineData("5530464618918194971810", "5.530464618918195e+21")]
    [InlineData("12345678901234567890.0", "12345678901234567000")]
    [InlineData("1.2345678901234567e19", "12345678901234567000")]
    // The Number.MIN_VALUE region, where a double.Parse that rounds twice is wrong about half the time.
    [InlineData("3.32605247755496039e-311", "3.326052477555e-311")]
    [InlineData("5e-324", "5e-324")]
    [InlineData("1e-323", "1e-323")]
    [InlineData("4.9406564584124654e-324", "5e-324")]
    [InlineData("2.4703282292062327e-324", "0")]
    [InlineData("2.4703282292062328e-324", "5e-324")]
    [InlineData("2.2250738585072011e-308", "2.225073858507201e-308")]
    ...
    [InlineData("1.7976931348623159e308", "Infinity")]
    [InlineData("1e309", "Infinity")]
    [InlineData("1e999", "Infinity")]
    [InlineData("1e-400", "0")]
    ...
    [InlineData("1.234_5e1_0", "12345000000")]
    ...
    [InlineData("1.00000000000000011102230246251565404236316680908203125", "1")]
    [InlineData("1.000000000000000111022302462515654042363166809082031251", "1.0000000000000002")]
    ...
    /// </summary>
    [Theory]
    [InlineData("28643790.0509245228")]
    [InlineData("1.95232124646081910e-200")]
    [InlineData("4.21015488674265630e+200")]
    [InlineData("1898787416396742135391")]
    [InlineData("3.32605247755496039e-311")]
    [InlineData("2.4703282292062328e-324")]
    [InlineData("2.2250738585072011e-308")]
    [InlineData("1.2345678901234567e19")]
    [InlineData("0.1")]
    [InlineData("1e23")]
    ...
    /// </summary>
    [Theory]
    [InlineData(LiteralShape.Fraction)]
    [InlineData(LiteralShape.PositiveExponent)]
    [InlineData(LiteralShape.NegativeExponent)]
    [InlineData(LiteralShape.Subnormal)]
    [InlineData(LiteralShape.WideWholeNumber)]
    [InlineData(LiteralShape.ShortFraction)]
    ...
    /// </summary>
    [Theory]
    [InlineData("1e123456789012345678901234567890", double.PositiveInfinity)]
    [InlineData("1e-123456789012345678901234567890", 0.0)]
    [InlineData("1e99999999999999999", double.PositiveInfinity)]
    [InlineData("1e-99999999999999999", 0.0)]
