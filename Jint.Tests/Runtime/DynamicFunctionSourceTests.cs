...
public class DynamicFunctionSourceTests
{
    ...
    [TestCase("a /* comment */, b", "return a + b", "1, 2")]
    [TestCase("a = (1 + 2)", "return a", "")]
    [TestCase("a = function () { return 3; }", "return a()", "")]
    [TestCase("a = `x${22}`", "return a.length", "")]
    [TestCase("{ a, b }", "return a + b", "{ a: 1, b: 2 }")]
    [TestCase("a,", "return a", "3")]
    [TestCase("a\n, b", "return a + b", "1, 2")]
    [TestCase("...a", "return a.length", "0, 0, 0")]
    ...
    [TestCase("Object.getPrototypeOf(function* () {}).constructor", "yield a")]
    [TestCase("Object.getPrototypeOf(async function () {}).constructor", "return a")]
    [TestCase("Object.getPrototypeOf(async function* () {}).constructor", "yield a")]
