...
namespace Jint.Tests.Ecma
{
    public class Test_15_11_1_1 : EcmaTest
    {
        ...
        {
			RunTest(@"TestCases/ch15/15.11/15.11.1/S15.11.1.1_A2_T1.js", false);
        }
        ...
        {
			RunTest(@"TestCases/ch15/15.11/15.11.1/S15.11.1.1_A3_T1.js", false);
        }
