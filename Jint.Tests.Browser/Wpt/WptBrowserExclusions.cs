...
internal static class WptBrowserExclusions
{
    ...
    [
        ...
        // ---------------------------------------------------------------- the selector engine: what it accepts, and five matching divergences
        // The selector table of Selectors-API, run three times: through matches(), through its prefixed
        // alias and through querySelector/querySelectorAll in four contexts. 2,791 of its 3,313 rows pass.
        // What is left is two kinds of thing, and neither is a selector this browser gets *wrong* — it is a
        // selector it should refuse and does not, or one whose subject a headless page does not have.
        // Recorded rather than fixed, for the reason NeedsTriage exists: the change that first runs a suite
        // is not also the change that moves the engine. Wpt/README.md names the causes.
        new("dom/nodes/Element-matches.html", "* :link, #pseudo-link :visited", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*#", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*#attr-value [align=\"center\"", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*#pseudo-link :enabled", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*#pseudo-link :link, #pseudo-link :visited", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*$|div", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*(", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*.", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*..test", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*.5cm", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*.foo..quux", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*:::before", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*:example", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*:not(ns|div)", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*matching every fourth child element, starting from the third, with whitespace (with refNode Element)*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*:target", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*<", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*>", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*Empty String: ", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*Invalid character: )", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*Invalid character: ]", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*Relative selector: >*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*[", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*[*=test]", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*[class= space unquoted ]", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*^|div", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*before", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*div % address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*div ++ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*div ~~ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*div,", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*div:example", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*div:linkexample", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*matching every second child element, starting from the fourth, with whitespace (with refNode Element)*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*ns|div", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*{", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "*}", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches.html", "DIV Element.matches no parameter", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "* :link, #pseudo-link :visited", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*#", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*#attr-value [align=\"center\"", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*#pseudo-link :enabled", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*#pseudo-link :link, #pseudo-link :visited", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*$|div", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*(", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*.", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*..test", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*.5cm", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*.foo..quux", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*:::before", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*:example", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*:not(ns|div)", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*matching every fourth child element, starting from the third, with whitespace (with refNode Element)*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*:target", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*<", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*>", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*Empty String: ", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*Invalid character: )", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*Invalid character: ]", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*Relative selector: >*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*[", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*[*=test]", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*[class= space unquoted ]", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*^|div", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*before", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*div % address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*div ++ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*div ~~ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*div,", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*div:example", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*div:linkexample", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*matching every second child element, starting from the fourth, with whitespace (with refNode Element)*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*ns|div", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*{", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "*}", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-webkitMatchesSelector.html", "DIV Element.webkitMatchesSelector no parameter", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "*#attr-value [align=\"center\"", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "*#no-namespace |*", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "*#no-namespace |div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "*#pseudo-link :enabled", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "*#pseudo-link :link, #pseudo-link :visited", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "*::slotted(foo", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "*::slotted(foo)", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "*:link and :visited pseudo-class selectors, matching no elements: #head :link, #head :visited", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "*:not(ns|div)", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "*Relative selector: >*", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "*ns|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector no parameter", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Empty String: ", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid ID: #", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid [att=value] selector: [*=test]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid [att=value] selector: [class= space unquoted ]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid character: (", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid character: )", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid character: <", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid character: >", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid character: [", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid character: {", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid character: }", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid class: .", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid class: ..test", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid class: .5cm", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid class: .bar.", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid class: .foo..quux", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid combinator: div % address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid combinator: div ++ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid combinator: div ~~ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid group of selectors: div,", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid namespace: $|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid namespace: ^|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid pseudo-element: :: before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Invalid pseudo-element: :::before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Unknown pseudo-class: :example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Unknown pseudo-class: div:example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Unknown pseudo-class: div:linkexample", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Unknown pseudo-element: ::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelector: Unknown pseudo-element: div::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll no parameter", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll returns NodeList instance", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Empty String: ", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid ID: #", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid [att=value] selector: [*=test]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid [att=value] selector: [class= space unquoted ]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid character: (", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid character: )", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid character: <", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid character: >", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid character: [", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid character: {", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid character: }", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid class: .", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid class: ..test", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid class: .5cm", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid class: .bar.", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid class: .foo..quux", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid combinator: div % address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid combinator: div ++ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid combinator: div ~~ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid group of selectors: div,", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid namespace: $|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid namespace: ^|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid pseudo-element: :: before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Invalid pseudo-element: :::before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Unknown pseudo-class: :example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Unknown pseudo-class: div:example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Unknown pseudo-class: div:linkexample", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Unknown pseudo-element: ::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Detached Element.querySelectorAll: Unknown pseudo-element: div::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector no parameter", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: :target pseudo-class selector, matching the element referenced by the URL fragment identifier: :target", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Empty String: ", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid ID: #", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid [att=value] selector: [*=test]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid [att=value] selector: [class= space unquoted ]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid character: (", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid character: )", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid character: <", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid character: >", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid character: [", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid character: {", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid character: }", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid class: .", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid class: ..test", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid class: .5cm", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid class: .bar.", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid class: .foo..quux", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid combinator: div % address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid combinator: div ++ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid combinator: div ~~ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid group of selectors: div,", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid namespace: $|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid namespace: ^|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid pseudo-element: :: before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Invalid pseudo-element: :::before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Unknown pseudo-class: :example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Unknown pseudo-class: div:example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Unknown pseudo-class: div:linkexample", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Unknown pseudo-element: ::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelector: Unknown pseudo-element: div::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll no parameter", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll returns NodeList instance", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: :target pseudo-class selector, matching the element referenced by the URL fragment identifier: :target", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Empty String: ", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid ID: #", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid [att=value] selector: [*=test]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid [att=value] selector: [class= space unquoted ]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid character: (", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid character: )", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid character: <", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid character: >", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid character: [", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid character: {", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid character: }", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid class: .", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid class: ..test", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid class: .5cm", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid class: .bar.", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid class: .foo..quux", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid combinator: div % address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid combinator: div ++ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid combinator: div ~~ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid group of selectors: div,", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid namespace: $|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid namespace: ^|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid pseudo-element: :: before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Invalid pseudo-element: :::before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Unknown pseudo-class: :example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Unknown pseudo-class: div:example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Unknown pseudo-class: div:linkexample", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Unknown pseudo-element: ::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Document.querySelectorAll: Unknown pseudo-element: div::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector no parameter", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Empty String: ", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid ID: #", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid [att=value] selector: [*=test]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid [att=value] selector: [class= space unquoted ]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid character: (", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid character: )", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid character: <", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid character: >", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid character: [", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid character: {", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid character: }", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid class: .", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid class: ..test", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid class: .5cm", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid class: .bar.", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid class: .foo..quux", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid combinator: div % address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid combinator: div ++ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid combinator: div ~~ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid group of selectors: div,", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid namespace: $|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid namespace: ^|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid pseudo-element: :: before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Invalid pseudo-element: :::before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Unknown pseudo-class: :example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Unknown pseudo-class: div:example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Unknown pseudo-class: div:linkexample", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Unknown pseudo-element: ::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelector: Unknown pseudo-element: div::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll no parameter", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll returns NodeList instance", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Empty String: ", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid ID: #", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid [att=value] selector: [*=test]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid [att=value] selector: [class= space unquoted ]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid character: (", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid character: )", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid character: <", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid character: >", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid character: [", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid character: {", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid character: }", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid class: .", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid class: ..test", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid class: .5cm", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid class: .bar.", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid class: .foo..quux", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid combinator: div % address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid combinator: div ++ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid combinator: div ~~ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid group of selectors: div,", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid namespace: $|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid namespace: ^|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid pseudo-element: :: before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Invalid pseudo-element: :::before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Unknown pseudo-class: :example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Unknown pseudo-class: div:example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Unknown pseudo-class: div:linkexample", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Unknown pseudo-element: ::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "Fragment.querySelectorAll: Unknown pseudo-element: div::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector no parameter", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: :target pseudo-class selector, matching the element referenced by the URL fragment identifier: :target", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Empty String: ", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid ID: #", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid [att=value] selector: [*=test]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid [att=value] selector: [class= space unquoted ]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid character: (", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid character: )", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid character: <", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid character: >", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid character: [", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid character: {", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid character: }", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid class: .", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid class: ..test", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid class: .5cm", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid class: .bar.", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid class: .foo..quux", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid combinator: div % address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid combinator: div ++ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid combinator: div ~~ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid group of selectors: div,", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid namespace: $|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid namespace: ^|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid pseudo-element: :: before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Invalid pseudo-element: :::before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Unknown pseudo-class: :example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Unknown pseudo-class: div:example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Unknown pseudo-class: div:linkexample", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Unknown pseudo-element: ::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelector: Unknown pseudo-element: div::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll no parameter", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll returns NodeList instance", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: :target pseudo-class selector, matching the element referenced by the URL fragment identifier: :target", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Empty String: ", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid ID: #", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid [att=value] selector: [*=test]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid [att=value] selector: [class= space unquoted ]", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid character: (", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid character: )", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid character: <", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid character: >", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid character: [", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid character: {", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid character: }", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid class: .", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid class: ..test", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid class: .5cm", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid class: .bar.", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid class: .foo..quux", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid combinator: div % address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid combinator: div ++ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid combinator: div ~~ address, p", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid group of selectors: div,", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid namespace: $|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid namespace: ^|div", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid pseudo-element: :: before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Invalid pseudo-element: :::before", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Unknown pseudo-class: :example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Unknown pseudo-class: div:example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Unknown pseudo-class: div:linkexample", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Unknown pseudo-element: ::example", WptDivergence.NeedsTriage),
        new("dom/nodes/ParentNode-querySelector-All.html", "In-document Element.querySelectorAll: Unknown pseudo-element: div::example", WptDivergence.NeedsTriage),
