...
internal static class WptBrowserExclusions
{
    ...
    [
        ...
        new("dom/lists/DOMTokenList-Iterable.html", "*entries method.", WptDivergence.NeedsTriage),
        new("dom/lists/DOMTokenList-Iterable.html", "*forEach method.", WptDivergence.NeedsTriage),
        new("dom/lists/DOMTokenList-Iterable.html", "*values method.", WptDivergence.NeedsTriage),
        ...
        new("dom/lists/DOMTokenList-iteration.html", "*prototype", WptDivergence.NeedsTriage),
        new("dom/lists/DOMTokenList-stringifier.html", "*", WptDivergence.NeedsTriage),
        new("dom/lists/DOMTokenList-value.html", "*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "Assigning*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\" *", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"\"*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"\\fa*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"\\na*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"\\ra*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"\\ta*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"a *", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"a\") with attribute value \"   a*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"a\") with attribute value \"a a*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"a\", \" *", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"a\", \"\"*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"a\", \"a*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"a\\f*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"a\\n*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"a\\r*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add(\"a\\t*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.add()*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.item*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove(\" *", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove(\"\"*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove(\"A\"*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove(\"\\fa*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove(\"\\na*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove(\"\\ra*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove(\"\\ta*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove(\"a *", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove(\"a\\f*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove(\"a\\n*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove(\"a\\r*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove(\"a\\t*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove(\"aa *", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove(\"d*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.remove()*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.replace*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toString*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\" *", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"\"*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"A\",*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"\\fa*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"\\na*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"\\ra*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"\\ta*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"a *", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"a\", false) with attribute value \"\"*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"a\", false) with attribute value null*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"a\\f*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"a\\n*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"a\\r*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"a\\t*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"aa *", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-classlist.html", "classList.toggle(\"d\", false*", WptDivergence.NeedsTriage),

        // ---------------------------------------------------------------- a member of a DOM interface the bindings do not have
        // a member of a DOM interface the bindings do not have
        new("dom/lists/DOMTokenList-iteration.html", "classList.*", WptDivergence.NeedsTriage),
        new("dom/nodes/Attr-prefix.html", "*", WptDivergence.NeedsTriage),
        new("dom/nodes/ChildNode-replaceWith.html", "*", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/Document-createEvent.https.html", "createEvent('dragevent*", WptDivergence.NeedsTriage),
        new("dom/nodes/Document-createEvent.https.html", "createEvent('storageevent*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-hasAttributes.html", "*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-insertAdjacentElement.html", "*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-insertAdjacentText.html", "*", WptDivergence.NeedsTriage),
        new("dom/nodes/Element-matches-namespaced-elements.html", "*webkitMatchesSelector", WptDivergence.NeedsTriage),
        new("dom/nodes/Node-childNodes.html", "Iterator*", WptDivergence.NeedsTriage),
        new("dom/nodes/Node-isSameNode.html", "*", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/attributes.html", "*shell)", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/attributes.html", "Basic functionality of*", WptDivergence.NeedsTriage),
        new("dom/nodes/attributes.html", "If*", WptDivergence.NeedsTriage),
        new("dom/nodes/attributes.html", "Toggling*", WptDivergence.NeedsTriage),
        new("dom/nodes/attributes.html", "setAttributeNode *", WptDivergence.NeedsTriage),
        new("dom/nodes/attributes.html", "toggleAttribute*", WptDivergence.NeedsTriage),
        new("dom/nodes/insert-adjacent.html", "*)", WptDivergence.NeedsTriage),
        new("dom/nodes/insert-adjacent.html", "*null", WptDivergence.NeedsTriage),
        new("dom/nodes/insert-adjacent.html", "invalid caller*", WptDivergence.NeedsTriage),
        new("dom/nodes/insert-adjacent.html", "invalid syntax*", WptDivergence.NeedsTriage),
        new("dom/nodes/remove-next-sibling-during-replace-with.html", "*", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/Document-createElementNS.html", "* HTML document: null,\"foo\",null", WptDivergence.NeedsTriage),
        new("dom/nodes/Document-createElementNS.html", "* HTML document: null,\"foo1\",null", WptDivergence.NeedsTriage),
        new("dom/nodes/Document-createElementNS.html", "* HTML document: null,\"ெfoo\",null", WptDivergence.NeedsTriage),
        new("dom/nodes/Document-createElementNS.html", "* HTML document: null,null,null", WptDivergence.NeedsTriage),
        new("dom/nodes/Document-createElementNS.html", "* HTML document: null,undefined,null", WptDivergence.NeedsTriage),
        new("dom/nodes/Document-createElementNS.html", "createElementNS test in HTML document: null,\"xml*null", WptDivergence.NeedsTriage),
        new("dom/nodes/Document-createElementNS.html", "createElementNS test in HTML document: undefined*null", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/Document-importNode.html", "*", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/Document-createElementNS.html", "null*", WptDivergence.NeedsTriage),
        new("dom/nodes/Document-createElementNS.html", "undefined*", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/attributes.html", "*in local name", WptDivergence.NeedsTriage),
        new("dom/nodes/attributes.html", "First*", WptDivergence.NeedsTriage),
        new("dom/nodes/attributes.html", "Non*", WptDivergence.NeedsTriage),
        new("dom/nodes/attributes.html", "Only*", WptDivergence.NeedsTriage),
        ...
        new("dom/nodes/attributes.html", "Style*", WptDivergence.NeedsTriage),
