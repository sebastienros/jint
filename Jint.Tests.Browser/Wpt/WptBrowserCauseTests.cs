...
public class WptBrowserCauseTests
{
    ...
    public async Task TheCauseTableMatchesWhatTheLaneMeasures()
    {
        ...
        // Validate every report before attributing any failures. A harness error can arrive after some
        // subtests have reported; treating that partial list as a complete cause measurement could make a
        // live cause look spent or let an update rewrite its row from incomplete evidence.
