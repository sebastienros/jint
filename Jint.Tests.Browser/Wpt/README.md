...
| ---: | ---: | --- |
| 137 | 1 | **ProcessingInstruction HTML parsing remains.** The attribute map and element serialization are implemented; 20 rows need HTML PI parsing ([#4098](https://github.com/sebastienros/jint/issues/4098)). <!-- cause: a member of a DOM interface the bindings do not have --> |
